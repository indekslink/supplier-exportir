...
<head>
  ...
  <title>Coconut Palm Sugar | Supplier-Exportir</title>
...
<body>
  ...
  <div id="slider" class="hero-konten">
    ...
    <p class="slide1">Coconut Palm Sugar</p>
    ...
    <img class="slide" src="img/kelapa/palm(3).jpeg" style="
          top: 10%;
          margin-left: 15%;
          width: 27%;
          height: 55%;
  ...
  <div class="margin-y">
    <div id="feature">
      ...
      <div class="flex-gallery">
        <a href="img/kelapa/palm(1).jpeg" class="progressive replace"><img src="img/kelapa/palm(1).jpeg" alt="" class="preview" /></a><a href="img/kelapa/palm(2).jpeg" class="progressive replace"><img src="img/kelapa/palm(2).jpeg" alt="" class="preview" /></a><a href="img/kelapa/palm(3).jpeg" class="progressive replace"><img src="img/kelapa/palm(3).jpeg" alt="" class="preview" /></a>
        <a href="img/kelapa/palm(4).jpeg" class="progressive replace"><img src="img/kelapa/palm(4).jpeg" alt="" class="preview" /></a>
      </div>
    </div>
  </div>
