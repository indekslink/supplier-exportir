...
<head>
  ...
  <title>Coconut | Supplier-Exportir</title>
...
<body>
  ...
  <div id="slider" class="hero-konten">
    <img src="https://hpf.co.id/img/blog/videotron-out/header.png" class="img" />
    <p class="slide1">Semi Husked Coconut</p>
    ...
    <img class="slide" src="img/kelapa/coco-2.jpeg" style="
          width: 27%;
  ...
  <div class="margin-y">
    <div id="feature">
      ...
      <div class="flex-gallery">
        <a href="img/kelapa/1.jpeg" class="progressive replace"><img src="img/kelapa/1.jpeg" alt="" class="preview" /></a><a href="img/kelapa/2.jpeg" class="progressive replace"><img src="img/kelapa/2.jpeg" alt="" class="preview" /></a><a href="img/kelapa/3.jpeg" class="progressive replace"><img src="img/kelapa/3.jpeg" alt="" class="preview" /></a>

        <a href="img/kelapa/coco-1.jpeg" class="progressive replace"><img src="img/kelapa/coco-1.jpeg" alt="" class="preview" /></a>
        <a href="img/kelapa/coco-2.jpeg" class="progressive replace"><img src="img/kelapa/coco-2.jpeg" alt="" class="preview" /></a>
        <a href="img/kelapa/coco-3.jpeg" class="progressive replace"><img src="img/kelapa/coco-3.jpeg" alt="" class="preview" /></a>
      </div>
    </div>
  </div>
