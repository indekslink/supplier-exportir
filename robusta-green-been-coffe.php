...
<head>
  ...
  <title>Robusta Green Been Coffe | Supplier-Exportir</title>
...
<body>
  ...
  <div id="slider" class="hero-konten">
    ...
    <p class="slide1">Robusta Green Been Coffe</p>
    ...
    <img class="slide" src="img/kelapa/kopi-1.jpeg" style="
          top: 10%;
          margin-left: 15%;
          width: 27%;
          height: 55%;
  ...
  <div class="margin-y">
    <div id="feature">
      ...
      <div class="flex-gallery">
        <a href="img/kelapa/kopi-1.jpeg" class="progressive replace"><img src="img/kelapa/kopi-1.jpeg" alt="" class="preview" /></a><a href="img/kelapa/kopi-2.jpeg" class="progressive replace"><img src="img/kelapa/kopi-2.jpeg" alt="" class="preview" /></a>
      </div>
    </div>
  </div>
