...
<html>
  <head>
    <meta
      name="description"
      content="Jual LCD Interactive Whiteboard, LCD Video Wall, Stand Alone, Kiosk, LCD Wallmount, LED Videotron Indoor & Outdoor, Webcam"
    />
    <meta
      name="keywords"
      content="HPF Digital Poster Signage | Spesifikasi LCD Interactive Whiteboard, LCD Video Wall, Stand Alone, Kiosk, LCD Wallmount, LED Videotron Indoor & Outdoor, Webcam"
    />
    <meta name="author" content="PT.SINAROZORA LESTARI" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />

    <title>Dessicated Coconut | Supplier-Exportir</title>
  ...
  <body>
    ...
    <div id="slider" class="hero-konten">
      <img
        class="img"
        src="https://hpf.co.id/img/blog/videotron-out/header.png"
        style="width: 100%; min-height: 50vh"
      />
      <p class="slide1">Dessicated Coconut</p>
    ...
    <div class="margin-y">
      <div id="feature">
        ...
        <div class="flex-gallery">
          <a href="img/kelapa/8.jpeg" class="progressive replace"
            ><img src="img/kelapa/8.jpeg" alt="" class="preview"
          /></a>
          <a href="img/kelapa/5.jpeg" class="progressive replace"
            ><img src="img/kelapa/5.jpeg" alt="" class="preview" /></a
          ><a href="img/kelapa/dc-1.jpeg" class="progressive replace"
            ><img src="img/kelapa/dc-1.jpeg" alt="" class="preview"
          /></a>
        </div>
      </div>
    </div>
