...
<head>
  ...
  <title>Export and Import Clearance | Supplier-Exportir</title>
...
<body>
  ...
  <div id="slider" class="hero-konten">
    <img class="img" src="https://hpf.co.id/img/blog/videotron-in/header.png" style="width: 100%; height: auto" />
    <p class="slide1">Export and Import Clearance</p>
    ...
    <img class="slide" src="img/kelapa/9.jpeg" style="
          width: 27%;
          top: 10%;
          margin-left: 15%;
  ...
  <div class="margin-y">
    <div id="feature">
      ...
      <div class="flex-gallery">
        <a href="img/kelapa/9.jpeg" class="progressive replace"><img src="img/kelapa/9.jpeg" alt="" class="preview" /></a><a href="img/kelapa/ei-1.jpeg" class="progressive replace"><img src="img/kelapa/ei-1.jpeg" alt="" class="preview" /></a>
        <a href="img/kelapa/ei-5.jpeg" class="progressive replace"><img src="img/kelapa/ei-5.jpeg" alt="" class="preview" /></a>
      </div>
    </div>
  </div>
